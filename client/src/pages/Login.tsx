    ...
    <div style={{ display: 'flex', minHeight: '100vh', width: '100%', background: '#ffffff' }}>
        ...
        >
          <div style={{ 
            ...
            <div style={{ padding: '48px 48px' }}>
              <div style={{ textAlign: 'center', marginBottom: 40 }}>
                <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: 32, fontWeight: 400, color: '#0f172a', marginBottom: 8 }}>
                  Welcome <span style={{ color: 'var(--accent)', fontStyle: 'italic', fontWeight: 600 }}>Back</span>
                </h2>
                <p style={{ fontSize: 15, color: '#64748b' }}>Sign in to access your AI-powered development environment.</p>
              </div>
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                ...
                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                    <label style={{ fontFamily: 'var(--font-mono)', fontSize: 11, fontWeight: 700, color: '#64748b', letterSpacing: '0.05em' }}>PASSWORD</label>
                    <span style={{ fontFamily: 'var(--font-mono)', fontSize: 11, fontWeight: 700, color: 'var(--accent)', cursor: 'pointer' }}>FORGOT?</span>
                  </div>
                  <div style={{ position: 'relative' }}>
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      required
                      style={{ width: '100%', padding: '14px 16px 14px 44px', borderRadius: 8, border: '1px solid #cbd5e1', fontSize: 15, color: '#0f172a', background: '#ffffff', letterSpacing: '0.1em', outline: 'none', transition: 'border 0.2s' }}
                      onFocus={(e) => e.target.style.border = '2px solid var(--accent)'}
                      onBlur={(e) => e.target.style.border = '1px solid #cbd5e1'}
                    />
                  </div>
            ...
            <div style={{ padding: '24px', borderTop: '1px solid #e2e8f0', background: '#f8fafc', textAlign: 'center', fontSize: 14, color: '#64748b', marginTop: 'auto' }}>
              Don't have an account? <span onClick={() => navigate('/register')} style={{ color: 'var(--accent)', fontWeight: 600, cursor: 'pointer' }}>Start Trial</span>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      <div className="hidden-mobile" style={{ flex: '1', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '40px', position: 'relative' }}>
        <motion.div 
          ...
          style={{ width: '100%', maxWidth: 700, position: 'relative', marginLeft: '-80px' }}
        >
          <motion.div
            animate={{ y: [-15, 15, -15] }}
